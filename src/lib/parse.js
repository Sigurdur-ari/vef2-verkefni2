...
export function parseIndexFileItem(potentialItem) {
   ...
   * @returns {Array} Parsed array of file items
   */
   ...
   * @returns {Array} Parsed questions or empty if invalid.
   */
   ...
   * @returns {*} Parsed answer or null if invalid
   */
